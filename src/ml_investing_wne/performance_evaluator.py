...
backtest_folder = '/root/ml_investing_wne/src/ml_investing_wne/models/ETHUSDTNOTA_96_cumsum_triple_barrier_keras_tuner_CNN_LSTM_cusum_002_triple_005_24'
...
# output folder
output_folder = '/root/ml_investing_wne/src/ml_investing_wne/results'
