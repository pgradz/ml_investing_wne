...
def procTickExample(msg):
    print("TICK: ", msg)
    with open('/Users/i0495036/Documents/sandbox/ml_investing_wne/ml_investing_wne/src/ml_investing_wne/data/xtb/bitcoin.json', mode='a') as f:
...
def main():
    ...
    resp = client.commandExecute('getTradingHours', {"symbols": ["BITCOIN"]})
    ...
    sclient.subscribePrices(['BITCOIN'])
